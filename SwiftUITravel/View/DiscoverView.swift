...
//
import SwiftUI
//step 5 create a color extension to remove the code duplication for the background
extension Color {
        ...
        NavigationView {
            ZStack {
                LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.9989629388, green: 0.6833450198, blue: 0.2572694123, alpha: 1)), Color(#colorLiteral(red: 0.9992215037, green: 0.5845271945, blue: 0.2407189906, alpha: 1))]), startPoint: .leading, endPoint: .center)
                    .ignoresSafeArea()
                Color.discoverBackground //step 6 replace
                    .offset(y: 400)
                ScrollView {
                    HStack {
                    ...
                    }.background(Color.discoverBackground) //step 7 replace
                    .cornerRadius(16)
                    .padding(.top, 32)
                }
            }
